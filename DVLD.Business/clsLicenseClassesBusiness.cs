...
{
    public class clsLicenseClassBusiness:clsLicenseClasses
    {
        ...
        public clsLicenseClassBusiness(int LicenseClassID, string ClassName,
        ...
        {
            return clsLicenseClassAccess.GetAllLicenseClasses();
